            ...
            <form class="form-horizontal form-row-seperated" action="{{ Route('admin-updateevent', ['id' => $model->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                    <div class=" row">
                        ...
                        <div class="col-lg-3">
                            <input type="text" class="form-control" name="title_en" value="{{ (old('title_en') != "") ? old('title_en') : $model->title_en }}" placeholder="event title in English">
                        ...
                        <div class="col-lg-3">
                            <input type="text" class="form-control" name="title_dr" value="{{ (old('title_dr') != "") ? old('title_dr') : $model->title_dr }}" placeholder="event title in Persian">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <input type="datetime-local" class="form-control" name="start_date" value="{{ (old('start_date') != "") ? old('start_date') : $model->start_date }}" placeholder="event title in English">
                        ...
                        <div class="col-md-3">
                            <input type="datetime-local" class="form-control" name="end_date" value="{{ (old('end_date') != "") ? old('end_date') : $model->end_date }}" placeholder="event title in Persian">
                    ...
                    <div class="row {{ $errors->has('image') ? ' has-error' : '' }}">
                        <label class="col-md-2 control-label">Change Picture <span class="required">*</span></label>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-4">
                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                <img src="{{ ($model->image != '') ? URL::asset('public/uploads/admin/event/' . $model->image) : URL::asset('public/backend/assets/pages/img/admin-default.jpg') }}" alt="" style="width: 200px; height: 150px;"> 
                            </div>
                        </div>
                    </div>
