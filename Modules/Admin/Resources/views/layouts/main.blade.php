...
<html lang="en">
    <head>
        ...
        <link href="{{ URL::asset('public/backend/assets/global/plugins/datatables/jquery.dataTables.min.css')}}" rel="stylesheet" type="text/css" />
        ...
        <link rel="stylesheet" href="{{URL::asset('public/backend/custom/select2/select2.min.css')}}" />
        <script src="{{ URL::asset('public/backend/assets/global/plugins/jquery.min.js') }}" type="text/javascript"></script>
        <link href="{{ URL::asset('public/backend/assets/global/plugins/loader/loading.css') }}" type="text/css">
        <link rel="shortcut icon" href="{{URL::asset('public/assets/img/company-logos/KWA_icon.png')}}">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid" style="background-color: #26344B;font-family: 'Open Sans',sans-serif;">
        ...
        <script src="{{ URL::asset('public/backend/assets/global/plugins/datatables/jquery.dataTables.min.js')}}" type="text/javascript"></script>
        <script src="{{ URL::asset('public/backend/assets/global/plugins/loader/loadingoverlay.min.js')}}" type="text/javascript"></script>
        ...
        <script type="text/javascript" src="{{URL::asset('public/backend/custom/select2/select2.full.min.js')}}"></script>
        <script type="text/javascript" src="{{URL::asset('public/frontend/custom/sweet_alert/sweetalert.min.js') }}"></script>
