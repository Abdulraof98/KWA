...
@section('breadcrumb')
<li>
    <span class="active">Boosters</span>
</li>
@stop
...
<div class="portlet box blue-hoki">
    ...
    <div class="pull-right"><a href="{{route('admin-addbooster')}}" class="btn btn-success" style="position: relative; top: 3px;"><i class="fa fa-plus"></i> Add New</a></div>
    </div>
...
<script>
    $(function () {
        $('#users-management').DataTable({
            processing: false,
            serverSide: true,
            ajax: '{{ Route("admin-booster-list-datatable") }}',
            order: [[5, "desc"]],
            columns: [
    ...
    function deleteTrainer(obj) {
        $.confirm({
            ...
            content: 'Are you sure to delete this booster?',
            type: 'red',
            typeAnimated: true,
            buttons: {
                confirm: {
