...
<li class="active">Experts</li>
@stop

@section('content')
<h3 class="page-title">Experts
    <small>Manage all the members of the site from here</small>
</h3>
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="pull-right">
                    <!--<a class="btn btn-success" href="{{ Route('admin-addbooster') }}"><i class="fa fa-plus" aria-hidden="true"></i> Create</a>&nbsp;-->
                    <a class="btn btn-info" href="javascript:;" onclick="$('#search_filter').toggle();"><i class="fa fa-search" aria-hidden="true"></i> Filter</a>&nbsp;
                    <a class="btn btn-info" href="{{ Route('admin-expert') }}"><i class="glyphicon glyphicon-repeat"></i></i> Reset</a>
                </div>
            </div>
                    ...
                    <table class="table table-striped table-bordered table-advance table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ Route('admin-viewexpert', ['id' => $val->id]) }}" class="btn btn-outline btn-circle btn-sm blue" data-toggle="tooltip" title="View">
                                        <i class="fa fa-eye"></i> 
                                    </a>
                                    <a href="{{Route('admin-updateexpert', ['id' => $val->id])}}" class="btn btn-outline btn-circle btn-sm purple" data-toggle="tooltip" title="Edit">
                                        <i class="fa fa-edit">&nbsp;&nbsp;</i> 
                                    </a>
                                    <a href="{{Route('admin-expertfiles', ['id' => $val->id])}}" class="btn btn-outline btn-circle btn-sm purple" data-toggle="tooltip" title="Files">
                                        <i class="fa fa-file">&nbsp;&nbsp;</i> 
                                    </a>
                                    <a href="javascript:;" onclick="deleteMember(this);" data-href="{{Route('admin-deletemember', ['id' => $val->id])}}" data-id="' . $val->id . '" class="btn btn-outline btn-circle btn-sm dark" data-toggle="tooltip" title="Delete">
