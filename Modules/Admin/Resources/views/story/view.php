...
@section('breadcrumb')
<li> <a href="{{ Route('admin-managestory') }}">Storys</a></li>
...
<div class="portlet light bordered">
    ...
    <div class="portlet-body form">
        ...
        <form class="form-horizontal">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <img class="img-responsive" style="width:200px; height:auto;" src="{{ URL::asset('public/uploads/admin/story/' . $model->image) }}" alt="{{ $model->image }}">
                            </div>
            ...
            <button href="{{route('admin-updatestory',['id'=>$model->id])}}" type="submit" class="btn green " >Update</button>
