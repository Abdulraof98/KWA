...
<div class="users-update">
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            <form class="form-horizontal form-row-seperated" action="{{ Route('admin-updateblog', ['id' => $model->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-body">
                    <div class="form-group {{ $errors->has('title_en') ? ' has-error' : '' }}">
                        <label class="col-md-3 control-label">Blog Title <span class="required">*</span></label>
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="title_en" value="{{ (old('title_en') != "") ? old('title_en') : $model->title_en }}" placeholder="Blog title English">
                    ...
                    <div class="form-group {{ $errors->has('title_dr') ? ' has-error' : '' }}">
                        <label class="col-md-3 control-label">Blog Title <span class="required">*</span></label>
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="title_dr" value="{{ (old('title_dr') != "") ? old('title_dr') : $model->title_dr }}" placeholder="Blog title Persian">
                    ...
                    <div class="form-group {{ $errors->has('image') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                <img src="{{ ($model->image != '') ? URL::asset('public/uploads/admin/blog/' . $model->image) : URL::asset('public/backend/assets/pages/img/admin-default.jpg') }}" alt="" style="width: 200px; height: 150px;"> 
                            </div>
                        </div>
                    </div>
