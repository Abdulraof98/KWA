...
<div class="portlet box blue-hoki">
    <div class="portlet-title">
        ...
        <div class="pull-right"><a href="{{route('admin-addcategory')}}" class="btn btn-success" style="position: relative; top: 3px;"><i class="fa fa-plus"></i> Add New</a></div>
    </div>
...
<script>
    $(function () {
        $('#category-management').DataTable({
            processing: false,
            serverSide: true,
            ajax: '{{ Route("admin-category-list-datatable") }}',
            order: [[3, "desc"]],
            columns: [
